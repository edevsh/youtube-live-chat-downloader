...
Obtiene mensajes del chat en vivo de YouTube sin necesidad de autenticación.

## ¿Cómo funciona?
* La solicitud para obtener el chat en vivo se recrea mediante el análisis del contenido HTML.
* La API de YouTube devuelve una `continuation` con nuevos mensajes del chat. Esta continuación se envía en la siguiente solicitud a la API para recibir nuevos mensajes y una nueva continuación.
...
Basado en chat-downloader de Xenova (https://github.com/xenova/chat-downloader)
